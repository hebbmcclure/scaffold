...
public abstract class BaseWebElement {
     ...
     */
    public BaseWebElement(By by, WebElement parentElement) {
        this.setBy(by);
     ...
     */
    protected BaseWebElement(WebElement element) {
...
//        }
    ...
    public void scrollIntoView() {
        try {
            getWebDriverWrapper().getJavascriptExecutor().executeScript("arguments[0].scrollIntoView(true);", getRawWebElement());
        } catch (Exception e) {
